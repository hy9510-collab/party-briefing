...
function renderGgCouncil() {
  ...
  view.innerHTML = `<div class="detail" style="--c:#0c4da2">
      ...
      ${grid("북")}
      <p class="note">정당별 의석수는 2026-06-03 제9회 지방선거 당선인(중앙선거관리위원회 명부) 기준입니다. 시·군의회는 지역구+비례 전체, 경기도의회(상단)는 지역구 도의원 합산입니다. 의장단은 2026년 6~7월 각 의회 개원·지역 언론 기준으로 확정된 곳만 표기했으며, 원구성 진행 중인 3곳(고양·안양·남양주)은 '선출 진행 중'으로 표시했습니다.</p>
    </div>`;
